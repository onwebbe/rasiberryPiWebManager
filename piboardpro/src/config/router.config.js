...

  {
    ...
    children: [
      // dashboard
      {
        ...
        redirect: '/dashboard/workplace',
        component: RouteView,
        meta: { title: '系统总览', keepAlive: true, icon: bxAnaalyse, permission: [ 'dashboard' ] },
        children: [
          {
            path: '/dashboard/PiGPIOStatus',
            name: 'piGPIOStatus',
            component: () => import('@/views/gpioOverview/PiGPIOStatus'),
            meta: { title: 'GIPO总览', keepAlive: false, permission: [ 'dashboard' ] }
          }
        ]
      },
      {
        ...
        component: PageView,
        meta: { title: 'PI Overview', icon: 'form', permission: [ 'pioverview' ] },
        children: [
          {
            path: '/pioverview/gpioOverview',
            name: 'gpioOverview',
            component: () => import('@/views/gpioOverview/PiGPIOStatus'),
